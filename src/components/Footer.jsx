...
const Footer = () => {        
    ...
    <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
            ...
            <p className='text-[30px] font-semibold'>Tilchattaas</p>
                ...
                <ul className="flex items-center space-x-3 mt-9">
                    <li>
                        <a href="https://x.com/tilchattaas" title="" className="flex items-center justify-center text-white transition-all duration-200 bg-gray-800 rounded-full w-7 h-7 hover:bg-blue-600 focus:bg-blue-600">
                    ...
                    <li>
                        <a href="https://instagram.com/tilchattas" target='_blank' title="" className="flex items-center justify-center text-white transition-all duration-200 bg-gray-800 rounded-full w-7 h-7 hover:bg-blue-600 focus:bg-blue-600">
                            <svg className="w-4 h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <li>
                        <a href="https://github.com/tilchattaas" target="_blank" title="" className="flex items-center justify-center text-white transition-all duration-200 bg-gray-800 rounded-full w-7 h-7 hover:bg-blue-600 focus:bg-blue-600">
                            <svg className="w-4 h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                                <path
                                    fill-rule="evenodd"
                                    clip-rule="evenodd"
        ...
        <p className="text-sm text-center text-gray-600">© Copyright 2021, All Rights Reserved by Tilchattaas</p>
    </div>
</section>
